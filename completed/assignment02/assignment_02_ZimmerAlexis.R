...
getwd()
print("C:/Users/alexi/OneDrive/Documents/GitHub/dsc520")

## List the contents of the working directory with the `dir()` function
dir()
print("assignments, completed, data, LICENSE, README.md, RMarkdown.md")
...
## Use `setwd()` if needed
setwd("C:/Users/alex/OneDrive/Documents/GitHub/dsc520")
...
person_df2 <- read.csv("data/tidynomicon/person.csv", stringAsFactors = FALSE)
str(person_df2)
...
voter_turnout_df1 <- read_excel("data/G04ResultsDetails2004-11-02.xls", skip = 1)
...
db <- dbConnect(RSQLite::SQLite(), dbname = "data/tidnomicon/example.db")
...
tables <- 1apply(table_names, dbReadTable, conn = db)
tables
